...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Item(ITEM_ID_SNAKE_FANG, "Snake fag", "Snake fags"));
        ...
        private static void PopulateQuests()
        {
            ...
            Quest clearFarmerField = new Quest(QUEST_ID_CLEAR_FARMERS_FIELD, "Clear the farmers field", "Kill snakes in the farmer's field and bring 3 snake fangs. You will receive an adventurer's pass and 20 gold pieces.", 20, 20);
        ...
        private static void PopulateLocations()
        {
            ...
            // Add the location to the static list
            Locations.Add(home);
